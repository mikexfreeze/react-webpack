...
import {deleteAsset, queryAssets} from "services/assetApi";
import AssetEditor from "routes/EndpointManage/Asset/AssetEditor";
...
class Asset extends Component {
  ...
  columnDefs = [{
    ...
    field: "assetCategory.name",
    headerComponentParams: { fm: {id: "assignment.common.assetcategory", defaultMessage: "资产类型"} },
  }, {
  ...
  render() {
    return (
      <div className="flex-content">
        ...
        <Drawer
          title={<Title>{this.msg['asset.listasset.addasset']}</Title>}
          placement="right"
          closable={false}
          ...
          width={700}
        >
          <AssetEditor onSuccess={this.hdlEditSuc} asset={this.state.asset} editStatus={this.state.editStatus} />
        </Drawer>
        <Drawer
